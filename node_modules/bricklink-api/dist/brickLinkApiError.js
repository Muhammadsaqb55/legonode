...
exports.BrickLinkApiError = void 0;
 ...
 */
var BrickLinkApiError = /*#__PURE__*/function (_Error) {
  _inherits(BrickLinkApiError, _Error);
  var _super = _createSuper(BrickLinkApiError);
  /**
   ...
   */
  function BrickLinkApiError(meta) {
    var _this;
    _classCallCheck(this, BrickLinkApiError);
    _this = _super.call(this, meta.message);
    _this.name = _this.constructor.name;
    _this.meta = meta;
    return _this;
  }
  return _createClass(BrickLinkApiError);
}( /*#__PURE__*/_wrapNativeSuper(Error));
exports.BrickLinkApiError = BrickLinkApiError;